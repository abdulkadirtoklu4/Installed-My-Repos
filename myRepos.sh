...
git clone https://github.com/abdulkadirtoklu4/Web-Site
git clone https://github.com/abdulkadirtoklu4/CsCalculator
...
echo -e "\033[32m[+]\033[0m Installed 'CsCalculator' Repo."
